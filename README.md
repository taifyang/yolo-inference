...
| YOLOv3u            | Detect           | GPU                | FP32                  | 10.0ms   | 11.9ms       | 26.2ms  | ?        | 6.1ms    |
| YOLOv3u            | Detect           | CPU                | FP16                  | ×        | 298.6ms      | 460.2ms | 87.2ms   | ×        |
| YOLOv3u            | Detect           | GPU                | FP16                  | 7.7ms    | 18.3ms       | 7.6ms   | ?        | 2.2ms    |
| YOLOv3u            | Detect           | CPU                | INT8                  | ×        | 243.3ms      | ×       | 97.4ms   | ×        |
| YOLOv3u            | Detect           | GPU                | INT8                  | ×        | 237.1ms      | ×       | ?        | 1.6ms    |
| YOLOv4             | Detect           | CPU                | FP32                  | ?        | 285.7ms      | 284.6ms | 64.5ms   | ×        |
| YOLOv4             | Detect           | GPU                | FP32                  | ?        | 11.5ms       | 19.0ms  | ?        | 4.5ms    |
| YOLOv4             | Detect           | CPU                | FP16                  | ×        | 342.3ms      | 281.5ms | 65.4ms   | ×        |
| YOLOv4             | Detect           | GPU                | FP16                  | ?        | 20.4ms       | 11.3ms  | ?        | 2.1ms    |
| YOLOv4             | Detect           | CPU                | INT8                  | ×        | 319.1ms      | ×       | 65.6ms   | ×        |
| YOLOv4             | Detect           | GPU                | INT8                  | ×        | 189.2ms      | ×       | ?        | 1.8ms    |
...
| YOLOv5n            | Detect           | GPU                | FP32                  | 4.9ms    | 7.7ms        | 7.1ms   | ?        | 0.9ms    |
| YOLOv5n            | Detect           | CPU                | FP16                  | ×        | 35.1ms       | 87.2ms  | 11.7ms   | ×        |
| YOLOv5n            | Detect           | GPU                | FP16                  | 4.6ms    | 14.3ms       | 6.5ms   | ?        | 0.7ms    |
| YOLOv5n            | Detect           | CPU                | INT8                  | ×        | 31.4ms       | ×       | 12.5ms   | ×        |
| YOLOv5n            | Detect           | GPU                | INT8                  | ×        | 27.4ms       | ×       | ?        | 0.7ms    |
| YOLOv5n            | Segment          | CPU                | FP32                  | 27.2ms   | 31.4ms       | 116.6ms | 14.1ms   | ×        |
| YOLOv5n            | Segment          | GPU                | FP32                  | 7.9ms    | 9.7ms        | 9.2ms   | ?        | 1.2ms    |
| YOLOv5n            | Segment          | CPU                | FP16                  | ×        | 42.8ms       | 116.1ms | 14.6ms   | ×        |
| YOLOv5n            | Segment          | GPU                | FP16                  | 7.6ms    | 19.2ms       | 8.7ms   | ?        | 0.9ms    |
| YOLOv5n            | Segment          | CPU                | INT8                  | ×        | 39.7ms       | ×       | 15.9ms   | ×        |
| YOLOv5n            | Segment          | GPU                | INT8                  | ×        | 33.5ms       | ×       | ?        | 0.9ms    |
| YOLOv6n            | Detect           | CPU                | FP32                  | 24.0ms   | 19.8ms       | 36.3ms  | 11.4ms   | ×        |
| YOLOv6n            | Detect           | GPU                | FP32                  | 4.6ms    | 8.1ms        | 5.4ms   | ?        | 1.0ms    |
| YOLOv6n            | Detect           | CPU                | FP16                  | ×        | 38.5ms       | 35.9ms  | 11.9ms   | ×        |
| YOLOv6n            | Detect           | GPU                | FP16                  | 4.5ms    | 17.0ms       | 6.3ms   | ?        | 0.7ms    |
| YOLOv6n            | Detect           | CPU                | INT8                  | ×        | 47.0ms       | ×       | 11.8ms   | ×        |
| YOLOv6n            | Detect           | GPU                | INT8                  | ×        | 42.9ms       | ×       | ?        | 0.6ms    |
| YOLOv7t            | Detect           | CPU                | FP32                  | 29.8ms   | 19.7ms       | 86.9ms  | 13.1ms   | ×        |
| YOLOv7t            | Detect           | GPU                | FP32                  | 5.6ms    | 7.8ms        | 6.0ms   | ?        | 1.1ms    |
| YOLOv7t            | Detect           | CPU                | FP16                  | ×        | 45.2ms       | 86.5ms  | 12.6ms   | ×        |
| YOLOv7t            | Detect           | GPU                | FP16                  | 5.1ms    | 16.9ms       | 5.5ms   | ?        | 0.8ms    |
| YOLOv7t            | Detect           | CPU                | INT8                  | ×        | 38.5ms       | ×       | 14.2ms   | ×        |
| YOLOv7t            | Detect           | GPU                | INT8                  | ×        | 39.6ms       | ×       | ?        | 0.7ms    |
| YOLOv8n            | Classify         | CPU                | FP32                  | 5.2ms    | 3.1ms        | 5.0ms   | 3.1ms    | ×        |
| YOLOv8n            | Classify         | GPU                | FP32                  | 1.2ms    | 1.1ms        | 1.8ms   | ?        | 0.5ms    |
...
| YOLOv8n            | Classify         | GPU                | INT8                  | ×        | 3.6ms        | ×       | ?        | 0.4ms    |
| YOLOv8n            | Detect           | CPU                | FP32                  | 24.6ms   | 34.4ms       | 64.6ms  | 13.6ms   | ×        |
| YOLOv8n            | Detect           | GPU                | FP32                  | 4.7ms    | 8.2ms        | 6.2ms   | ?        | 1.1ms    |
| YOLOv8n            | Detect           | CPU                | FP16                  | ×        | 43.8ms       | 64.2ms  | 13.2ms   | ×        |
| YOLOv8n            | Detect           | GPU                | FP16                  | 4.5ms    | 17.1ms       | 6.0ms   | ?        | 0.8ms    |
| YOLOv8n            | Detect           | CPU                | INT8                  | ×        | 43.2ms       | ×       | 16.2ms   | ×        |
| YOLOv8n            | Detect           | GPU                | INT8                  | ×        | 38.1ms       | ×       | ?        | 0.7ms    |
| YOLOv8n            | Segment          | CPU                | FP32                  | 33.0ms   | 39.2ms       | 70.0ms  | 16.2ms   | ×        |
| YOLOv8n            | Segment          | GPU                | FP32                  | 7.3ms    | 10.1ms       | 8.3ms   | ?        | 1.6ms    |
| YOLOv8n            | Segment          | CPU                | FP16                  | ×        | 51.5ms       | 69.6ms  | 16.5ms   | ×        |
| YOLOv8n            | Segment          | GPU                | FP16                  | 7.5ms    | 21.5ms       | 8.4ms   | ?        | 1.1ms    |
| YOLOv8n            | Segment          | CPU                | INT8                  | ×        | 49.2ms       | ×       | 20.4ms   | ×        |
| YOLOv8n            | Segment          | GPU                | INT8                  | ×        | 42.4ms       | ×       | ?        | 1.0ms    |
...
| YOLOv8n            | Pose             | GPU                | FP16                  | 4.0ms    | 12.4ms       | 6.3ms   | ?        | 0.8ms    |
...
| YOLOv8n            | OBB              | GPU                | FP32                  | 183.4ms  | 189.0ms      | 179.0ms | ?        | 2.8ms    |
...
| YOLOv9t            | Detect           | GPU                | FP32                  | 7.5ms    | 10.3ms       | 11.2ms  | ?        | 2.0ms    |
| YOLOv9t            | Detect           | CPU                | FP16                  | ×        | 52.3ms       | 60.6ms  | 17.9ms   | ×        |
| YOLOv9t            | Detect           | GPU                | FP16                  | 7.9ms    | 16.6ms       | 12.8ms  | ?        | 1.6ms    |
| YOLOv9t            | Detect           | CPU                | INT8                  | ×        | 56.9ms       | ×       | 25.5ms   | ×        |
| YOLOv9t            | Detect           | GPU                | INT8                  | ×        | 45.4ms       | ×       | ?        | 1.7ms    |
...
| YOLOv9c            | Segment          | GPU                | FP16                  | 9.5ms    | 48.0ms       | 12.6ms  | ?        | 2.3ms    |
| YOLOv9c            | Segment          | CPU                | INT8                  | ×        | 178.1ms      | ×       | 68.3ms   | ×        |
| YOLOv9c            | Segment          | GPU                | INT8                  | ×        | 159.0ms      | ×       | ?        | 1.8ms    |
| YOLOv10n           | Detect           | CPU                | FP32                  | 25.9ms   | 30.0ms       | 54.7ms  | 14.4ms   | ×        |
| YOLOv10n           | Detect           | GPU                | FP32                  | 4.9ms    | 9.0ms        | ×       | ?        | 1.2ms    |
| YOLOv10n           | Detect           | CPU                | FP16                  | ×        | 55.3ms       | 54.3ms  | 14.1ms   | ×        |
| YOLOv10n           | Detect           | GPU                | FP16                  | 4.8ms    | 16.2ms       | ×       | ?        | 0.9ms    |
...
| YOLOv11n           | Detect           | GPU                | FP32                  | 5.1ms    | 8.4ms        | ×       | ?        | 1.1ms    |
| YOLOv11n           | Detect           | CPU                | FP16                  | ×        | 55.5ms       | 57.5ms  | 14.7ms   | ×        |
| YOLOv11n           | Detect           | GPU                | FP16                  | 5.2ms    | 17.6ms       | ×       | ?        | 0.9ms    |
| YOLOv11n           | Detect           | CPU                | INT8                  | ×        | 42.6ms       | ×       | 17.1ms   | ×        |
| YOLOv11n           | Detect           | GPU                | INT8                  | ×        | 38.1ms       | ×       | ?        | 0.9ms    |
| YOLOv11n           | Segment          | CPU                | FP32                  | 35.8ms   | 39.8ms       | 77.9ms  | 18.5ms   | ×        |
| YOLOv11n           | Segment          | GPU                | FP32                  | 8.0ms    | 11.8ms       | ×       | ?        | 1.7ms    |
| YOLOv11n           | Segment          | CPU                | FP16                  | ×        | 68.0ms       | 77.5ms  | 18.2ms   | ×        |
| YOLOv11n           | Segment          | GPU                | FP16                  | 8.7ms    | 21.5ms       | ×       | ?        | 1.3ms    |
| YOLOv11n           | Segment          | CPU                | INT8                  | ×        | 55.5ms       | ×       | 21.3ms   | ×        |
| YOLOv11n           | Segment          | GPU                | INT8                  | ×        | 47.9ms       | ×       | ?        | 1.1ms    |
| YOLOv11n           | Pose             | CPU                | FP32                  | 32.6ms   | 35.5ms       | 52.1ms  | 15.2ms   | ×        |
| YOLOv11n           | Pose             | GPU                | FP32                  | 5.1ms    | 9.2ms        | ×       | ?        | 1.3ms    |
...
| YOLOv11n           | OBB              | GPU                | FP32                  | 155.8ms  | 161.4ms      | ×       | ?        | 3.1ms    |
| YOLOv11n           | OBB              | CPU                | FP16                  | ×        | ×            | 320.0ms | 156.6ms  | ×        |
| YOLOv11n           | OBB              | GPU                | FP16                  | 161.5ms  | ×            | ×       | ?        | 2.5ms    |
| YOLOv11n           | OBB              | CPU                | INT8                  | ×        | 239.8ms      | ×       | 155.1ms  | ×        |
| YOLOv11n           | OBB              | GPU                | INT8                  | ×        | 230.1ms      | ×       | ?        | 2.4ms    |
...
| YOLOv12n           | Classify         | GPU                | FP16                  | 2.6ms    | 2.2ms        | 5.3ms   | ?        | 0.7ms    |
...
| YOLOv12n           | Detect           | GPU                | FP32                  | 6.6ms    | 9.4ms        | 10.5ms  | ?        | 1.6ms    |
| YOLOv12n           | Detect           | CPU                | FP16                  | ×        | 71.2ms       | 157.6ms | 18.4ms   | ×        |
| YOLOv12n           | Detect           | GPU                | FP16                  | 6.7ms    | 19.1ms       | 11.3ms  | ?        | 1.2ms    |
| YOLOv12n           | Detect           | CPU                | INT8                  | ×        | 61.3ms       | ×       | 21.2ms   | ×        |
| YOLOv12n           | Detect           | GPU                | INT8                  | ×        | 52.1ms       | ×       | ?        | 1.5ms    |
| YOLOv12n           | Segment          | CPU                | FP32                  | 47.6ms   | 47.8ms       | 191.6ms | 23.2ms   | ×        |
| YOLOv12n           | Segment          | GPU                | FP32                  | 9.6ms    | 12.5ms       | 13.2ms  | ?        | 2.0ms    |
| YOLOv12n           | Segment          | CPU                | FP16                  | ×        | 84.2ms       | 191.2ms | 23.4ms   | ×        |
| YOLOv12n           | Segment          | GPU                | FP16                  | 9.6ms    | 22.0ms       | 13.6ms  | ?        | 1.5ms    |
| YOLOv12n           | Segment          | CPU                | INT8                  | ×        | 74.4ms       | ×       | 27.3ms   | ×        |
| YOLOv12n           | Segment          | GPU                | INT8                  | ×        | 57.6ms       | ×       | ?        | 1.8ms    |
| YOLOv12n           | Pose             | CPU                | FP32                  | 40.4ms   | 40.0ms       | 136.6ms | 19.7ms   | ×        |
| YOLOv12n           | Pose             | GPU                | FP32                  | 6.0ms    | 9.8ms        | 10.1ms  | ?        | 1.6ms    |
...
| YOLOv12n           | OBB              | GPU                | FP32                  | 82.9ms   | 92.6ms       | 86.0ms  | ?        | 3.7ms    |
| YOLOv12n           | OBB              | CPU                | FP16                  | ×        | ×            | 510.2ms | 79.4ms   | ×        |
| YOLOv12n           | OBB              | GPU                | FP16                  | 82.2ms   | ×            | 86.5ms  | ?        | 3.0ms    |
| YOLOv12n           | OBB              | CPU                | INT8                  | ×        | 244.5ms      | ×       | 80.8ms   | ×        |
| YOLOv12n           | OBB              | GPU                | INT8                  | ×        | 181.0ms      | ×       | ?        | 3.1ms    |
| YOLOv13n           | Detect           | CPU                | FP32                  | 50.1ms   | 45.7ms       | 183.1ms | 21.7ms   | ×        |
| YOLOv13n           | Detect           | GPU                | FP32                  | 7.9ms    | 9.9ms        | 14.3ms  | ?        | 2.0ms    |
| YOLOv13n           | Detect           | CPU                | FP16                  | ×        | 97.6ms       | 182.7ms | 21.5ms   | ×        |
| YOLOv13n           | Detect           | GPU                | FP16                  | 7.9ms    | 19.2ms       | 16.4ms  | ?        | 1.6ms    |
| YOLOv13n           | Detect           | CPU                | INT8                  | ×        | 109.2ms      | ×       | 22.2ms   | ×        |
| YOLOv13n           | Detect           | GPU                | INT8                  | ×        | 84.4ms       | ×       | ?        | 2.5ms    |
