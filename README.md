...
| YOLOv9t            | Segment          | CPU                | FP32                  | 137.4ms  | 175.1ms      | 308.9ms | 64.2ms   | ×        |
| YOLOv9t            | Segment          | GPU                | FP32                  | 10.9ms   | 27.5ms       | 19.0ms  | ?        | 5.2ms    |
| YOLOv9t            | Segment          | CPU                | FP16                  | ×        | 182.6ms      | 308.5ms | 63.9ms   | ×        |
| YOLOv9t            | Segment          | GPU                | FP16                  | 9.5ms    | 48.0ms       | 12.6ms  | ?        | 2.8ms    |
| YOLOv9t            | Segment          | CPU                | INT8                  | ×        | 178.1ms      | ×       | 67.4ms   | ×        |
| YOLOv9t            | Segment          | GPU                | INT8                  | ×        | 159.0ms      | ×       | ?        | 2.2ms    |
...
| YOLOv9t            | Segment          | CPU                | FP32                  | 222.4ms  | 204.2ms      | 438.0ms | 114.9ms  | ×        |
| YOLOv9t            | Segment          | GPU                | FP32                  | 46.1ms   | 75.5ms       | 50.7ms  | ?        | 36.1ms   |
| YOLOv9t            | Segment          | CPU                | FP16                  | ×        | 241.8ms      | 437.6ms | 114.6ms  | ×        |
| YOLOv9t            | Segment          | GPU                | FP16                  | 46.0ms   | 76.8ms       | 43.1ms  | ?        | 33.8ms   |
| YOLOv9t            | Segment          | CPU                | INT8                  | ×        | 235.9ms      | ×       | 129.4ms  | ×        |
| YOLOv9t            | Segment          | GPU                | INT8                  | ×        | 233.6ms      | ×       | ?        | 25.2ms   |
