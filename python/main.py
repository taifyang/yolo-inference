...
LastEditTime: 2024-08-21 00:01:44
Description: 调用demo
'''
...
def parse_args():
    ...
    parser.add_argument('--algo_type', default='YOLOv5', type=str, help='YOLOv5, YOLOv6, YOLOv7, YOLOv8, YOLOv9, YOLOv10')
    parser.add_argument('--backend_type', default='OpenCV', type=str, help='ONNXRuntime, OpenCV, OpenVINO, TensorRT')
    ...
    parser.add_argument('--model_path', default='./weights/yolov5n_fp32.onnx', type=str, help='the path of model')
