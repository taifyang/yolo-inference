...
LastEditTime: 2026-01-21 09:04:03
Description: demo
'''
...
def parse_args():
    ...
    parser.add_argument('--backend_type', default='OpenVINO', type=str, help='PyTorch, ONNXRuntime, OpenCV, OpenVINO, TensorRT')
    parser.add_argument('--task_type', default='Segment', type=str, help='Classify, Detect, Segment, Pose, OBB')
    ...
    parser.add_argument('--model_path', default='./weights/yolo26n_seg_fp32.xml', type=str, help='the path of model')
...
if __name__ == '__main__':
    ...
    if not args.output_path:
        args.output_path = str(args.algo_type)+'_'+str(args.backend_type)+'_'+str(args.task_type)+'_'+str(args.device_type)+'_'+str(args.model_type)+ os.path.splitext(args.input_path)[-1] 
