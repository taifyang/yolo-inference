...
LastEditTime: 2026-01-12 11:00:32
Description: demo
'''
...
def parse_args():
    ...
    parser.add_argument('--algo_type', default='YOLOv11', type=str, help='YOLOv3, YOLOv4, YOLOv5, YOLOv6, YOLOv7, YOLOv8, YOLOv9, YOLOv10, YOLOv11, YOLOv12, YOLOv13')
    parser.add_argument('--backend_type', default='TensorRT', type=str, help='PyTorch, ONNXRuntime, OpenCV, OpenVINO, TensorRT')
    parser.add_argument('--task_type', default='OBB', type=str, help='Classify, Detect, Segment, Pose, OBB')
    ...
    parser.add_argument('--model_path', default='../weights/yolov11n_obb_fp32.engine', type=str, help='the path of model')
    parser.add_argument('--input_path', default='../boats.jpg', type=str, help='the input path of input image or video')
