...
@REM python main.py --algo_type YOLOv8 --backend_type OpenCV --device_type GPU --model_type FP32 --model_path yolov8n_fp32.onnx
python main.py --algo_type YOLOv8 --backend_type OpenCV --device_type CPU --model_type FP16 --model_path yolov8n_fp16.onnx
@REM python main.py --algo_type YOLOv8 --backend_type OpenCV --device_type GPU --model_type FP16 --model_path yolov8n_fp16.onnx
