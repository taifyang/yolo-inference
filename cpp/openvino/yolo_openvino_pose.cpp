 ...
 * @LastEditTime: 2026-01-20 21:58:06
* @Description: source file for YOLO openvino pose
 */

 #include "yolo_openvino.h"

 void YOLO_OpenVINO_Pose::init(const Algo_Type algo_type, const Device_Type device_type, const Model_Type model_type, const std::string model_path)
{
...
void YOLO_OpenVINO_Pose::pre_process()
{
