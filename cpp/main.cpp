...
{
	std::cout << "Libtorch CPU FP32" << std::endl;
	{
	...
	std::cout << "Libtorch GPU FP32" << std::endl;
	{
		std::unique_ptr<YOLOv5> yolov5 = AlgoFactory::instance().create(Algo_Type::Libtorch);
	...
	std::cout << "Libtorch GPU FP16" << std::endl;
	{
		std::unique_ptr<YOLOv5> yolov5 = AlgoFactory::instance().create(Algo_Type::Libtorch);
	...
	std::cout << "ONNXRuntime CPU FP32" << std::endl;
	{
	...
	std::cout << "ONNXRuntime GPU FP32" << std::endl;
	{
		std::unique_ptr<YOLOv5> yolov5 = AlgoFactory::instance().create(Algo_Type::ONNXRuntime);
	...
	std::cout << "ONNXRuntime CPU FP16" << std::endl;
	{
		std::unique_ptr<YOLOv5> yolov5 = AlgoFactory::instance().create(Algo_Type::ONNXRuntime);
	...
	std::cout << "ONNXRuntime GPU FP16" << std::endl;
	{
		std::unique_ptr<YOLOv5> yolov5 = AlgoFactory::instance().create(Algo_Type::ONNXRuntime);
	...
	std::cout << "ONNXRuntime CPU INT8" << std::endl;
	{
		std::unique_ptr<YOLOv5> yolov5 = AlgoFactory::instance().create(Algo_Type::ONNXRuntime);
	...
	std::cout << "ONNXRuntime GPU INT8" << std::endl;
	{
		std::unique_ptr<YOLOv5> yolov5 = AlgoFactory::instance().create(Algo_Type::ONNXRuntime);
	...
	std::cout << "OpenCV CPU FP32" << std::endl;
	{
	...
	std::cout << "OpenCV GPU FP32" << std::endl;
	{
		std::unique_ptr<YOLOv5> yolov5 = AlgoFactory::instance().create(Algo_Type::OpenCV);
		yolov5->init("yolov5n_fp32.onnx", GPU, FP32);
		yolov5->infer("test.mp4");
	...
	std::cout << "OpenVINO CPU FP32" << std::endl;
	{
	...
	std::cout << "OpenVINO GPU FP32" << std::endl;
	{
		std::unique_ptr<YOLOv5> yolov5 = AlgoFactory::instance().create(Algo_Type::OpenVINO);
	...
	std::cout << "OpenVINO CPU FP16" << std::endl;
	{
		std::unique_ptr<YOLOv5> yolov5 = AlgoFactory::instance().create(Algo_Type::OpenVINO);
	...
	std::cout << "OpenVINO GPU FP16" << std::endl;
	{
		std::unique_ptr<YOLOv5> yolov5 = AlgoFactory::instance().create(Algo_Type::OpenVINO);
	...
	std::cout << "OpenVINO CPU INT8" << std::endl;
	{
		std::unique_ptr<YOLOv5> yolov5 = AlgoFactory::instance().create(Algo_Type::OpenVINO);
	...
	std::cout << "OpenVINO GPU INT8" << std::endl;
	{
		std::unique_ptr<YOLOv5> yolov5 = AlgoFactory::instance().create(Algo_Type::OpenVINO);
	...
	std::cout << "TensorRT GPU FP32" << std::endl;
	{
	...
	std::cout << "TensorRT GPU FP16" << std::endl;
	{
		std::unique_ptr<YOLOv5> yolov5 = AlgoFactory::instance().create(Algo_Type::TensorRT);
	...
	std::cout << "TensorRT GPU INT8" << std::endl;
	{
		std::unique_ptr<YOLOv5> yolov5 = AlgoFactory::instance().create(Algo_Type::TensorRT);
